 ...
 *
 * Searches upward from CWD (or a given path) for `wt.config.js`,
...
const DEFAULTS = {
  ...
  docker: {
    ...
    generate: {
      ...
      entrypointScript: null, // e.g. 'docker-entrypoint.sh' — added as ENTRYPOINT if set
      extraMounts: [],
      extraEnv: {},
...
/**
 * Load and resolve the wt config.
 *
