 ...
 * read_offset, get_container_name, read_container_name,
...
// without config (no wt.config.js in the test environment).
...
describe('get_env_filename', () => {
  test('returns default when no config', () => {
    ...
    // Without a wt.config.js in the test env, config is null
...
describe('read_offset', () => {
  ...
  test('reads WORKTREE_PORT_OFFSET from env file', () => {
