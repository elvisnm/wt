 ...
 * have safe fallbacks for when no wt.config.js is present.
 */
 ...
 * Checks WORKTREE_PORT_OFFSET, WORKTREE_PORT_BASE in the env file,
 * then falls back to the compose file, then computes automatically.
 */
