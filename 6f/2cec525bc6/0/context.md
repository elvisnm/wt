...
lets make some adjustments on the UI - I saw that we have "Loding..." on the Usage panel, we should always use the spinner on places were we have this "..." - the spinner is the one we use in the loading page

### Prompt 23

let's make this spinner orange collor as we have for the loading screem for example
