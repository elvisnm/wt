...
func TestDetailsPanelExactHeight(t *testing.T) {
	wts := []worktree.Worktree{
		...
		},
		{
			...
			Container: "myapp-my-feat", Domain: "my-feat.localhost",
...
func TestJoinVerticalTotalHeight(t *testing.T) {
	wts := []worktree.Worktree{
		{Name: "test-1", Alias: "t1", Branch: "feat/test", Type: worktree.TypeLocal, Domain: "t1.localhost"},
