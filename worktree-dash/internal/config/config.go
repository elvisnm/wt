// Package config loads and provides access to the wt.config.js configuration.
//
...
const ConfigFilename = "wt.config.js"

// Config is the top-level wt configuration.
type Config struct {
...
// FindConfig walks upward from start_dir looking for wt.config.js.
...
// Load finds and parses wt.config.js, resolves defaults and paths.
